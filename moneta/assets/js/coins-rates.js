...
function loadCoinsRates() {
    ...
    jQuery.ajax(settings).done(function (response) {
        ...
        try{
            ...
            jQuery("#zoloto-md-date-gpm").text(response.find(x => x.Site == ZolotoMDMMD && x.Acronim == "GPM").ParseDate);
    ...
    try{
        ...
        jQuery("#zolotoy-zapas-date-gpm").text(response.find(x => x.Site == ZolotoyZapasMMD && x.Acronim == "GPM").ParseDate);
    ...
    try{
        ...
        jQuery("#zolotoydvor-date-gpm").text(response.find(x => x.Site == ZolotoyDvorCoinUrl && x.Acronim == "GPM").ParseDate);
    ...
    try{
        ...
        jQuery("#zolotoy-club-date-gpm").text(response.find(x => x.Site == ZolotoyClub && x.Acronim == "GPM").ParseDate);
    ...
    try{
        ...
        jQuery("#vfbank-date-gpm").text(response.find(x => x.Site == VfBankCoinUrl && x.Acronim == "GPM").ParseDate);
    ...
    try{
        ...
        jQuery("#rshb-date-gpm").text(response.find(x => x.Site == RshbCoinUrl && x.Acronim == "GPM").ParseDate);
    ...
    try{
        ...
        jQuery("#sberbank-date-gpm").text(response.find(x => x.Site == SberbankCoinUrl && x.Acronim == "GPM").ParseDate);
    ...
    try{
        ...
        jQuery("#ricgold-date-gpm").text(response.find(x => x.Site == RicGoldMMD && x.Acronim == "GPM").ParseDate);
    ...
    try{
        ...
        jQuery("#monetainvest-date-gpm").text(response.find(x => x.Site == MonetaInvestMMD && x.Acronim == "GPM").ParseDate);
    ...
    try{
        ...
        jQuery("#lanta-date-gpm").text(response.find(x => x.Site == LantaRuCoinsUrl && x.Acronim == "GPM").ParseDate);
    ...
    try{
        ...
        jQuery("#tsbnk-date-gpm").text(response.find(x => x.Site == CoinsTsbnkMMD && x.Acronim == "GPM").ParseDate);
    ...
    try{
        ...
        jQuery("#9999d-date-gpm").text(response.find(x => x.Site == Site9999d && x.Acronim == "GPM").ParseDate);
    ...
    try{
        ...
        jQuery("#zoloto-md-date-gps").text(response.find(x => x.Site == ZolotoMDSPMD && x.Acronim == "GPS").ParseDate);
    ...
    try{
        ...
        jQuery("#zolotoy-zapas-date-gps").text(response.find(x => x.Site == ZolotoyZapasSPMD && x.Acronim == "GPS").ParseDate);
    ...
    try{
        ...
        jQuery("#zolotoydvor-date-gps").text(response.find(x => x.Site == ZolotoyDvorCoinUrl && x.Acronim == "GPS").ParseDate);
    ...
    try{
        ...
        jQuery("#zolotoy-club-date-gps").text(response.find(x => x.Site == ZolotoyClub && x.Acronim == "GPS").ParseDate);
    ...
    try{
        ...
        jQuery("#vfbank-date-gps").text(response.find(x => x.Site == VfBankCoinUrl && x.Acronim == "GPS").ParseDate);
    ...
    try{
        ...
        jQuery("#rshb-date-gps").text(response.find(x => x.Site == RshbCoinUrl && x.Acronim == "GPS").ParseDate);
    ...
    try{
        ...
        jQuery("#sberbank-date-gps").text(response.find(x => x.Site == SberbankCoinUrl && x.Acronim == "GPS").ParseDate);
    ...
    try{
        ...
        jQuery("#ricgold-date-gps").text(response.find(x => x.Site == RicGoldSPMD && x.Acronim == "GPS").ParseDate);
    ...
    try{
        ...
        jQuery("#monetainvest-date-gps").text(response.find(x => x.Site == "https://msk.monetainvest.ru/" && x.Acronim == "GPS").ParseDate);
    ...
    try{
        ...
        jQuery("#lanta-date-gps").text(response.find(x => x.Site == LantaRuCoinsUrl && x.Acronim == "GPS").ParseDate);
    ...
    try{
        ...
        jQuery("#tsbnk-date-gps").text(response.find(x => x.Site == CoinsTsbnkSPMD && x.Acronim == "GPS").ParseDate);
    ...
    try{
        ...
        jQuery("#9999d-date-gps").text(response.find(x => x.Site == Site9999d && x.Acronim == "GPS").ParseDate);

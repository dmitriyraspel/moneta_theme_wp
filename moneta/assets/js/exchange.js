...
function loadTicker() {
  ...
  jQuery.ajax(settings).done(function (response) {
    jQuery("#gold-span_1").text("$ " + response[2].buy);
    jQuery("#gold-span_2").text("$ " + response[2].buy);
    jQuery("#gold-span_3").text("$ " + response[2].buy);

    jQuery("#silver-span_1").text("$ " + response[4].buy);
    jQuery("#silver-span_2").text("$ " + response[4].buy);
    jQuery("#silver-span_3").text("$ " + response[4].buy);

    jQuery("#platinum-span_2").text("$ " + response[3].buy);
    jQuery("#platinum-span_1").text("$ " + response[3].buy);
    jQuery("#platinum-span_3").text("$ " + response[3].buy);

    jQuery("#usd-span_1").html(response[0].buy + " руб.");
    jQuery("#usd-span_2").html(response[0].buy + " руб.");
    jQuery("#usd-span_3").html(response[0].buy + " руб.");

    jQuery("#eur-span_1").html(response[1].buy + " руб.");
    jQuery("#eur-span_2").html(response[1].buy + " руб.");
    jQuery("#eur-span_3").html(response[1].buy + " руб.");
  ...
  jQuery.ajax(settings).done(function (response) {
    ...
    try {
      ...
      jQuery("#zoloto-md-date-gpm").text(
        CoinsRatesDateFormat(
          response.find((x) => x.Site == ZolotoMDMMD && x.Acronim == "GPM").Date
        )
      );
    ...
    try {
      ...
      jQuery("#zolotoy-club-date-gpm").text(
        CoinsRatesDateFormat(
          response.find((x) => x.Site == ZolotoyClub && x.Acronim == "GPM").Date
        )
      );
    ...
    try {
      ...
      jQuery("#rshb-date-gpm").text(
        CoinsRatesDateFormat(
          response.find((x) => x.Site == RshbCoinUrl && x.Acronim == "GPM").Date
        )
      );
    ...
    try {
      ...
      jQuery("#ricgold-date-gpm").text(
        CoinsRatesDateFormat(
          response.find((x) => x.Site == RicGoldMMD && x.Acronim == "GPM").Date
        )
      );
    ...
    try {
      ...
      jQuery("#9999d-date-gpm").text(
        CoinsRatesDateFormat(
          response.find((x) => x.Site == Site9999d && x.Acronim == "GPM").Date
        )
      );
    ...
    try {
      ...
      jQuery("#zolotoy-club-date-gps").text(
        CoinsRatesDateFormat(
          response.find((x) => x.Site == ZolotoyClub && x.Acronim == "GPS").Date
        )
      );
    ...
    try {
      ...
      jQuery("#rshb-date-gps").text(
        CoinsRatesDateFormat(
          response.find((x) => x.Site == RshbCoinUrl && x.Acronim == "GPS").Date
        )
      );
    ...
    try {
      ...
      jQuery("#ricgold-date-gps").text(
        CoinsRatesDateFormat(
          response.find((x) => x.Site == RicGoldSPMD && x.Acronim == "GPS").Date
        )
      );
    ...
    try {
      ...
      jQuery("#9999d-date-gps").text(
        CoinsRatesDateFormat(
          response.find((x) => x.Site == Site9999d && x.Acronim == "GPS").Date
        )
      );
